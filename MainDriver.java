...
public class MainDriver {
    // trace1: cost-benefit
    // trace2: static
    public static void spliceResults(String trace1Res, String trace2Res, String resultLink) {
        ...
        try {
            ...
            while (line1 != null) {
                ...
                float epoch1Hitrate = Float.valueOf(reader1.readLine().split(" ")[2]);
                float lifetime1Hitrate = Float.valueOf(reader1.readLine().split(" ")[2]);
                reader1.readLine();
                line1 = reader1.readLine();

                float epoch2Hitrate = Float.valueOf(reader2.readLine().split(" ")[2]);
                float lifetime2Hitrate = Float.valueOf(reader2.readLine().split(" ")[2]);
                reader2.readLine();
                reader2.readLine();
    ...
    public static void main(String[] args) {
        for (int i = 1; i < 20; i++) {
            ...
            spliceResults(costBenefitRes, staticRes, splicedRes);
